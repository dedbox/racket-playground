...
(define (start-client title)
  ...
  (define Fs (list (sprite (dummy 600 600 green black) 0. 0.)))
  (define Ws
    (list* (sprite (dummy 600 20) 0. -300.)
           (sprite (dummy 600 20) 0.  300.)
           (sprite (dummy 20 600) -300. 0.)
           (sprite (dummy 20 600)  300. 0.)
           (sprite (dummy 20 20) -300. -300.)
           (sprite (dummy 20 20) -300.  300.)
           (sprite (dummy 20 20)  300. -300.)
           (sprite (dummy 20 20)  300.  300.)
           (for*/list ([x1 (in-range -200 201 100)]
                       [x2 (in-range -200 201 100)])
             (sprite (dummy 20 20) (->fl x1) (->fl x2)))))
